...
*/ -}}
{{- define "eric-oss-policy-admin.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-policy-admin.mergeAnnotations" -}}
  {{- include "eric-oss-policy-admin.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-policy-admin.mergeLabels" -}}
  {{- include "eric-oss-policy-admin.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
