...
CMD ["/bin/sh", "-c", "java ${JAVA_OPTS} -Dcom.sun.management.jmxremote=true \
    ...
    -jar eric-oss-policy-admin-app.jar"]
...
LABEL \
    org.opencontainers.image.title=eric-oss-policy-admin-jsb \
